...
function displaySearch() {
    let term = `
        <div class="col-md-6 py-5">
            <input id="search" type="search" placeholder="Search By Name"  class="form-control w-75 mx-auto  bg-dark-subtle rounded-2 text-black shadow-none border-white border-1 border-top border-end border-start px-3 ByName">
        </div>
        <div class="col-md-6 py-5">
            <input id="search" type="search" placeholder="Search By Frist Letter" maxlength="1" class="form-control w-75 mx-auto bg-dark-subtle rounded-2 text-black shadow-none border-white border-1 border-top border-end border-start px-3 ByFristLetter">
        </div>
    `
    $('#contact').html(null);
    $('#hero .box').html(null);
...
function displayContact()
{
    ...
    <form>
        <div class="row mt-3 ms-5">
            <div class="col-md-6">
                <input type="text" required id="name" maxlength="37" class="form-control mt-4" bg-dark-subtle rounded-2 text-black shadow-none border-white border-1 border-top border-end border-start placeholder="Enter Your Name">
